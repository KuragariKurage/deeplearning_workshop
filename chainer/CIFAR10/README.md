...
class Model(Chain):
 ...
 ```
 こんなかんじ
 ![accuracy](./cifar10_result/cg.png)
 
 
- **main.py**

もともとchainerでデータセットが提供されてるけどちゃんと書いてみた。
```
def unpickle(f):
    import cPickle
    fo = open(f, 'rb')
...
![loss](./cifar10_result/loss.png)
![accuracy](./cifar10_result/accuracy.png)
